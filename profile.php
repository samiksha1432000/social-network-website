  ...
  <body>
    <div class="row">
      ...
      <div class="col-sm-8">
        ...
        <ul class='nav-pull-right' style='position:absolute;top:90%;left:40%;'>
        <li class='dropdown'>
        <button id='button_style' class='dropdown-toggle btn btn-default' data-toggle='dropdown'>Change Cover</button>
        <div class='dropdown-menu'>
        <center>
        <p>
        Click <strong>Select cover</strong>and then click the <br><strong>Update Cover</strong></p>
        ...
        <div id='profile-img'>
          <img src='users/$user_image' alt='Profile' class='img-circle' width='160px' height='165px'>;
          <form  action='profile.php?u_id=user_id' method='post' enctype='multipart/form-data'>
        ...
        ";
         ...
         if(isset($_POST['submit'])){
           ...
           $img_tmp=$_FILES['u_cover']['tmp_name'];
           ...
           if($u_cover==''){
             ...
             move_uploaded_file($img_tmp,"cover/$u_cover.$random_number");
      ...
      if(isset($_POST['update'])){
        ...
        if($u_image==''){
          ...
          move_uploaded_file($img_tmp,"users/$u_image.$random_number");
        ...
        while($row_posts=mysqli_fetch_array($run_posts)){
          ...
          $row_user=mysqli_fetch_array($run_user);
            ...
            if($content=="No"&&strlen($upload_image)>=1){
              ...
              class='btn btn-danger'>Delete</button></a><br>
              </div><br><br>
              ";
        }
