...
<?php
$con=mysqli_connect("localhost","root","samiksha","social_network") or die("connection was not established");
function insertPost(){
  if(isset($_POST['sub'])){
    global $con;
    global $user_id;
  ...
  while($row_posts = mysqli_fetch_array($run_posts)){
    ...
    $row_user=mysqli_fetch_array($run_user);
      ...
      if($content=="No"&&strlen($upload_image)>=1){
        ...
        <div class='col-sm-6'>
        <h3><a style='text-decoration:none;cursor:pointer;color:#000408;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
        <h4> <small style='color:black;'>Update apost on<strong>$post_date</strong></small></h4>
        </div>
        <div class='col-sm-4'>
        </div>
        </div>
...
function search_user(){
  ...
  while($row_user=mysqli_fetch_array($run_user)){
    ...
    <img src='users/$user_image' class='img-circle' width ='150px' height='140px' title='$username' style='float:left;margin:1px;'/>
    </a>
    </div><br><br>
    <div class='col-sm-6'>
    <a style='text-decoration:none;cursor:pointer;color:black;' href='user_profile.php?u_id=$user_id'>
